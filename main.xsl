...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:xsi="http://www.w3.org/1999/XMLSchema-instance" xmlns:xf="http://www.w3.org/2002/xforms"
    xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl"
    version="2.0">
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <script type="text/javascript" src="Content/scripts/bootstrap.js"/>
                <script type="text/javascript" src="Content/scripts/jquery-1.11.1.min.js"/>
                <script type="text/javascript" src="Content/scripts/modernizr-2.6.2.js"/>
                ...
                <xf:model id="model{position()}">
                    ...
                    <!-- XForms binding -->
                    <xsl:for-each
                        select="uiml/interface/behavior/rule/condition/event[@class='binding']">
                        <xf:bind>
